  ...
  _expandInfo(ev) {
    ...
    if (classes.hasClass("weapon-range")) {
      ...
      //@HOUSE
        ...
        expansionText =
        `<a class="range-click" data-range="${item.range.bands[`${game.i18n.localize("Point Blank")}`].modifier}">${item.range.bands[`${game.i18n.localize("Point Blank")}`].range[0]} ${game.i18n.localize("yds")} - ${item.range.bands[`${game.i18n.localize("Point Blank")}`].range[1]} ${game.i18n.localize("yds")} (${item.range.bands[`${game.i18n.localize("Point Blank")}`].modifier}) - ${game.i18n.localize("Point Blank")}</a><br>
          <a class="range-click" data-range="${item.range.bands[`${game.i18n.localize("Short Range")}`].modifier}">${item.range.bands[`${game.i18n.localize("Short Range")}`].range[0]} ${game.i18n.localize("yds")} - ${item.range.bands[`${game.i18n.localize("Short Range")}`].range[1]} ${game.i18n.localize("yds")} (${item.range.bands[`${game.i18n.localize("Short Range")}`].modifier}) - ${game.i18n.localize("Short Range")}</a><br>
          <a class="range-click" data-range="${item.range.bands[`${game.i18n.localize("Normal")}`].modifier}">${item.range.bands[`${game.i18n.localize("Normal")}`].range[0]} ${game.i18n.localize("yds")} - ${item.range.bands[`${game.i18n.localize("Normal")}`].range[1]} ${game.i18n.localize("yds")} (${item.range.bands[`${game.i18n.localize("Normal")}`].modifier}) - ${game.i18n.localize("Normal")}</a><br>
          <a class="range-click" data-range="${item.range.bands[`${game.i18n.localize("Long Range")}`].modifier}">${item.range.bands[`${game.i18n.localize("Long Range")}`].range[0]} ${game.i18n.localize("yds")} - ${item.range.bands[`${game.i18n.localize("Long Range")}`].range[1]} ${game.i18n.localize("yds")} (${item.range.bands[`${game.i18n.localize("Long Range")}`].modifier}) - ${game.i18n.localize("Long Range")}</a><br>
          <a class="range-click" data-range="${item.range.bands[`${game.i18n.localize("Extreme")}`].modifier}">${item.range.bands[`${game.i18n.localize("Extreme")}`].range[0]} ${game.i18n.localize("yds")} - ${item.range.bands[`${game.i18n.localize("Extreme")}`].range[1]} ${game.i18n.localize("yds")} (${item.range.bands[`${game.i18n.localize("Extreme")}`].modifier}) - ${game.i18n.localize("Extreme")}</a><br>
          `
      }
      //@/HOUSE
